 ...
 * @author Leandro
 */
public class Romboide extends javax.swing.JFrame {

    /**
     * Creates new form Resistencia
     */
    
    Operaciones_G op=new Operaciones_G();
    public Romboide() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Área del Romboide");
        ...
        jLabel4.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 16)); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        double alt= Double.parseDouble(jTextPane9.getText());
        double baseMa= Double.parseDouble(jTextPane8.getText());
        double baseMe= Double.parseDouble(jTextPane7.getText());
        jTextPane10.setText(String.valueOf(op.Romboide(baseMe, baseMa, alt)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Romboide.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
